...
var pathToImages = conpath+'/images/';	// Relative to your HTML file
...
function pickDate(e,inputDay)
{
	...
	if(option=="search"){
      ...
      else if(option=="getslot")
    	  {
    	  getSlot_Calendar();
    	  }
    	  else if(option=="copySemi"){
    	       copyTimeSemi();
    	        }
         else{
...
function displayCalendar(getoption,inputField,format,buttonObj,displayTime,timeInput)
{
option=getoption;
	...
	if(todayDate.length>0)
	{
		...
		var monthPos = dateFormatForBanner.indexOf('mm');
		currentMonth = todayDate.substr(monthPos,2);
		var yearPos = dateFormatForBanner.indexOf('yyyy');
		currentYear = todayDate.substr(yearPos,4);
		var dayPos = dateFormatForBanner.indexOf('dd');
		tmpDay = todayDate.substr(dayPos,2);
		inputDay=tmpDay;
		currentMonth--;
	...
	currentMonth = d.getMonth();
	currentYear = d.getFullYear();
	currentHour = dd.getHours()   ;//'08';
	currentMinute = dd.getMinutes();//'00';
